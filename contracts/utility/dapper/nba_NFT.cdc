...
pub contract nba_NFT: NonFungibleToken {
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: nba_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: nba_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        thumbnail: MetadataViews.HTTPFile(
                            url: nba_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!
                        )
                    )
                ...
                case Type<MetadataViews.Editions>():
                    let maxEditions = nba_NFT.setData[self.setId]?.maxEditions ?? 0
                ...
                case Type<MetadataViews.ExternalURL>():
                    if let externalBaseURL = nba_NFT.getSetMetadataByField(setId: self.setId, field: "external_token_base_url") {
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    for metadataKey in nba_NFT.getSetMetadata(setId: self.setId)!.keys {
                        ...
                        if metadataKey.length >= 13 {
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_" {
                                ...
                                let royaltyAddress = nba_NFT.convertStringToAddress(nba_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_addr_".concat(royaltyName))!)!
                                let royaltyReceiver: PublicPath = PublicPath(identifier: nba_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_rcv_".concat(royaltyName))!)!
                                let royaltyCut = nba_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_cut_".concat(royaltyName))!
                                let cutValue: UFix64 = nba_NFT.royaltyCutStringToUFix64(royaltyCut)
                                if cutValue != 0.0 {
                                    royalties.append(MetadataViews.Royalty(
                                        ...
                                        cut: cutValue,
                                        description: nba_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!
                                    )
                                    )
                                }
                            }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: nba_NFT.CollectionStoragePath,
                        publicPath: nba_NFT.CollectionPublicPath,
                        providerPath: /private/nba_NFT,
                        publicCollection: Type<&nba_NFT.Collection{nba_NFT.nba_NFTCollectionPublic,NonFungibleToken.CollectionPublic}>(),
                        publicLinkedType: Type<&nba_NFT.Collection{nba_NFT.nba_NFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&nba_NFT.Collection{nba_NFT.nba_NFTCollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        createEmptyCollectionFunction: (fun (): @NonFungibleToken.Collection {
                            return <-nba_NFT.createEmptyCollection()
                        })
                    )
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/nba/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/nba/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    ...
                    for metadataKey in nba_NFT.getSetMetadata(setId: self.setId)!.keys {
                        ...
                        if metadataKey.length >= 18 {
                            if metadataKey.slice(from: 0, upTo: 18) == "collection_social_" {
                                ...
                                socials.insert(key: metadataKey.slice(from: 18, upTo: metadataKey.length), MetadataViews.ExternalURL(nba_NFT.getSetMetadataByField(setId: self.setId, field: metadataKey)!))
                            }
                        }
                    }
                    return MetadataViews.NFTCollectionDisplay(
                        name: nba_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "",
                        description: nba_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "",
                        externalURL: MetadataViews.ExternalURL(nba_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""),
                    ...
                    for metadataKey in nba_NFT.getSetMetadata(setId: self.setId)!.keys {
                        ...
                        if metadataKey.length >= 6 {
                            if metadataKey.slice(from: 0, upTo: 6) == "trait_" {
                                ...
                                traitDictionary.insert(key: metadataKey.slice(from: 6, upTo: metadataKey.length), nba_NFT.getSetMetadataByField(setId: self.setId, field: metadataKey)!)
                            }
                        }
                    }
    ...
    //
    pub resource Collection: nba_NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection {
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver} {
            ...
            let nba_NFTNft = nft as! &nba_NFT.NFT
            return nba_NFTNft as &AnyResource{MetadataViews.Resolver}
        }
